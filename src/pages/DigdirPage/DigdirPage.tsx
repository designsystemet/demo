      ...
      <div id='digdir-page'>
        ...
        <ImageSection flipped>
          <ImageSection.Left>
            ...
            <Paragraph variant='long' data-size='md'>
              Little. The to their congress, seven the seeing labour, in parts
              so four place meet now stupid and he title ensure same by been
              line the watched enjoying every title or joke. That the morning,
              above need bit slogging of the in salesman the the answering more
              truth, concept chief.
            </Paragraph>
          </ImageSection.Left>
          <ImageSection.Right>
